...
describe('QuerystringSerializer', () => {
    describe('serialize', () => {
        it('should serialize an object into a query string', () => {
            ...
            const expected = 'name=John%20Doe&age=25&hobbies[0]=reading&hobbies[1]=swimming&address.city=New%20York&address.country=USA';
    ...
    describe('parse', () => {
        it('should parse a query string into an object', () => {
            const queryString = 'name=John%20Doe&age=25&hobbies[0]=reading&hobbies[1]=swimming&address.city=New%20York&address.country=USA';
    ...
    it('should make some fun', function () {
        ...
        let serialized = QuerystringSerializer.serialize(
            wut,
            funParameters
        )
